	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img alt="Charisma Logo" src="/Public/Admin/img/logo20.png" /> <span>Charisma</span></a>
				...
				<div class="top-nav nav-collapse">
					<ul class="nav">
						<li><a href="#"><font size="4">首页</font></a></li>
						<li><a href="#"><font size="4">商品管理</font></a></li>
						<li>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="index.html"><i class="icon-home"></i><span class="hidden-tablet"> 站点信息</span></a></li>
					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="info">
								...
								<p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="/Public/Admin/img/qrcode136.png" />
							</div>
